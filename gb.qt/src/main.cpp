...
static void hook_error(int code, char *error, char *where)
{
  ...
  msg = "<b>This application has raised an unexpected<br>error and must abort.</b><br><br>[%1] %2.<br>%3";
...
static void QT_CreateFont(QFont &f)
{
  CFONT_create(f);
}
...
char *GB_INCLUDE EXPORT = "gb.draw";
