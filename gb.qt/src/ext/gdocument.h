...
typedef
  void (*GHighlightCallback)(GEditor *master, uint &state, GString &s, GHighlightArray *highlight, bool &proc);
...
public:
  ...
  static void highlightGambas(GEditor *master, uint &state, GString &s, GHighlightArray *data, bool &proc);
  ...
  int wordLeft(int y, int x, bool word);
  int wordRight(int y, int x, bool word);
