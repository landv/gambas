GB_DESC CButtonDesc[] =
{
  ...
  GB_CONSTANT("_Properties", "s", "*,Action,Text,Picture,Border=True,Default,Cancel"),
  GB_CONSTANT("_DefaultEvent", "s", "Click"),
  GB_CONSTANT("_DefaultSize", "s", "15,3"),
...
GB_DESC CToggleButtonDesc[] =
{
  ...
  GB_CONSTANT("_Properties", "s", "*,Action,Text,Picture,Border=True,Radio,Value"),
  GB_CONSTANT("_DefaultEvent", "s", "Click"),
  GB_CONSTANT("_DefaultSize", "s", "15,3"),
...
GB_DESC CToolButtonDesc[] =
{
  ...
  GB_CONSTANT("_Properties", "s", "*,Action,Text,Picture,Border,Radio,Toggle,Value"),
  GB_CONSTANT("_DefaultEvent", "s", "Click"),
  GB_CONSTANT("_DefaultSize", "s", "3,3"),
