...
BEGIN_PROPERTY(CTEXTBOX_alignment)
  ...
  if (READ_PROPERTY)
    //GB.ReturnInteger((TEXTBOX->alignment() & ALIGN_HMASK) + Qt::AlignHCenter);
    GB.ReturnInteger((TEXTBOX->alignment() & ALIGN_HMASK) + Qt::AlignVCenter);
  else
    //TEXTBOX->setAlignment((PROPERTY(long) & ALIGN_HMASK) + Qt::AlignVCenter);
    TEXTBOX->setAlignment(VPROP(GB_INTEGER) & ALIGN_HMASK);
...
GB_DESC CTextBoxSelectionDesc[] =
{
  ...
  //GB_METHOD("Clear", NULL, CTEXTBOX_sel_clear, NULL),
  GB_METHOD("Hide", NULL, CTEXTBOX_sel_clear, NULL),
  //GB_METHOD("All", NULL, CTEXTBOX_sel_select, NULL),
  //GB_METHOD("_call", NULL, CTEXTBOX_sel_select, "[(Start)i(Length)i]"),
...
GB_DESC CTextBoxDesc[] =
{
  ...
  GB_CONSTANT("_Properties", "s", "*,Text,Alignment{Align.Normal;Left;Center;Right}=Normal,ReadOnly,Password,MaxLength,Border=True"),
...
GB_DESC CComboBoxDesc[] =
{
  ...
  GB_CONSTANT("_Properties", "s", "*,Text,ReadOnly,Password,MaxLength,List,Sorted"),
