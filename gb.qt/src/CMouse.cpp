...
BEGIN_METHOD(CCURSOR_new, GB_OBJECT picture; GB_INTEGER x; GB_INTEGER y)
  ...
  //GB.StoreObject(ARG(picture), (void **)&THIS->picture);
...
BEGIN_PROPERTY(CMOUSE_shift)
  ...
  //CHECK_VALID();
  GB.ReturnBoolean(CMOUSE_info.state & Qt::ShiftButton);
...
BEGIN_PROPERTY(CMOUSE_control)
  ...
  //CHECK_VALID();
  GB.ReturnBoolean(CMOUSE_info.state & Qt::ControlButton);
...
BEGIN_PROPERTY(CMOUSE_alt)
  ...
  //CHECK_VALID();
  GB.ReturnBoolean(CMOUSE_info.state & Qt::AltButton);
...
BEGIN_PROPERTY(CMOUSE_meta)
  ...
  //CHECK_VALID();
  GB.ReturnBoolean(CMOUSE_info.state & Qt::MetaButton);
...
BEGIN_PROPERTY(CMOUSE_normal)
  ...
  //CHECK_VALID();
  GB.ReturnBoolean((CMOUSE_info.state & Qt::KeyButtonMask) == 0);
