...
#define CTEXTBOX_PROPERTIES "*,ReadOnly,Text,Alignment{Align.Normal;Left;Center;Right}=Normal,Password,MaxLength,Border=True"
#define CTEXTAREA_PROPERTIES "*,ReadOnly,Text,Wrap,Border=True,ScrollBar{Scroll.*}=Both"
...
#define CCOMBOBOX_PROPERTIES "*,ReadOnly,List,Text,Password,MaxLength,Sorted"
...
#define CTABSTRIP_PROPERTIES "*," CARRANGEMENT_PROPERTIES ",Count{Range:1;256}=1,Index,Text,Picture,Orientation{TabStrip.Top;Bottom}=Top"
#define CWINDOW_PROPERTIES "*,Action,Text,Icon,Picture,Mask,Persistent,Border{Window.None;Fixed;Resizable}=Resizable,ToolBox,Stacking{Window.Normal;Above;Below}=Normal,Minimized,Maximized,FullScreen,Sticky,SkipTaskbar," CARRANGEMENT_PROPERTIES
