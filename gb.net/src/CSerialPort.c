...
GB_STREAM_DESC SerialStream = {
	CSerialPort_stream_open,
	CSerialPort_stream_close,
	CSerialPort_stream_read,
	CSerialPort_stream_write,
	CSerialPort_stream_seek,
	CSerialPort_stream_tell,
	CSerialPort_stream_flush,
	CSerialPort_stream_eof,
	CSerialPort_stream_lof,
	CSerialPort_stream_handle
};
