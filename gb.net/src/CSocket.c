...
GB_STREAM_DESC SocketStream = {
	CSocket_stream_open,
	CSocket_stream_close,
	CSocket_stream_read,
	CSocket_stream_write,
	CSocket_stream_seek,
	CSocket_stream_tell,
	CSocket_stream_flush,
	CSocket_stream_eof,
	CSocket_stream_lof,
	CSocket_stream_handle
};
/**********************************
...
int CSocket_connect_socket(CSOCKET *mythis,char *sHost,int lenhost,int myport)
{
	...
	*******************************************/
	if (!mythis->DnsTool)
	{
		GB.New((void**)&mythis->DnsTool,GB.FindClass("DnsClient"),NULL,NULL);
