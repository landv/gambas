...
IMPLEMENT_TSP_I(CSIZE, c_lflag)
IMPLEMENT_TSP(CSTOPB, c_lflag)
IMPLEMENT_TSP(CREAD, c_lflag)
IMPLEMENT_TSP(PARENB, c_lflag)
IMPLEMENT_TSP(PARODD, c_lflag)
IMPLEMENT_TSP(HUPCL, c_lflag)
IMPLEMENT_TSP(CLOCAL, c_lflag)
IMPLEMENT_TSP(CMSPAR, c_lflag)
IMPLEMENT_TSP(CRTSCTS, c_lflag)

IMPLEMENT_TSP(ISIG, c_cflag)
IMPLEMENT_TSP(ICANON, c_cflag)
IMPLEMENT_TSP(XCASE, c_cflag)
IMPLEMENT_TSP(ECHO, c_cflag)
IMPLEMENT_TSP(ECHOE, c_cflag)
IMPLEMENT_TSP(ECHOK, c_cflag)
IMPLEMENT_TSP(ECHONL, c_cflag)
IMPLEMENT_TSP(ECHOCTL, c_cflag)
IMPLEMENT_TSP(ECHOPRT, c_cflag)
IMPLEMENT_TSP(ECHOKE, c_cflag)
IMPLEMENT_TSP(FLUSHO, c_cflag)
IMPLEMENT_TSP(NOFLSH, c_cflag)
IMPLEMENT_TSP(TOSTOP, c_cflag)
IMPLEMENT_TSP(PENDIN, c_cflag)
IMPLEMENT_TSP(IEXTEN, c_cflag)
