...
PUBLIC int GB_GetInterface(const char *library, long version, void *iface);
...
PUBLIC void GB_Return(unsigned long type, ...);
...
PUBLIC void GB_ReturnPtr(unsigned long type, void *value);
...
PUBLIC char *GB_RealFileName(const char *path, long len);
...
PUBLIC long GB_CollectionCount(GB_COLLECTION col);
PUBLIC void GB_CollectionSet(GB_COLLECTION col, const char *key, long len, GB_VARIANT *value);
PUBLIC int GB_CollectionGet(GB_COLLECTION col, const char *key, long len, GB_VARIANT *value);
PUBLIC int GB_CollectionEnum(GB_COLLECTION col, GB_VARIANT *value, char **key, long *len);
...
PUBLIC int GB_NumberToString(int flag, double value, const char *format, char **str, long *len);
...
EXTERN unsigned long GAMBAS_ReturnType;
EXTERN unsigned long GAMBAS_MissingParam;
