...
BEGIN_METHOD(COBSERVER_new, GB_OBJECT object)
	...
	//fprintf(stderr, "COBSERVER_new: this = %p  object = %s.%p  parent = %p\n", this, class->name, object, parent);
...
BEGIN_METHOD_VOID(COBSERVER_free)
	...
	//fprintf(stderr, "COBSERVER_free: this = %p\n", this);
...
PUBLIC GB_DESC NATIVE_Observer[] =
{
  ...
  GB_METHOD("_new", NULL, COBSERVER_new, "(Object)o"),
...
PUBLIC GB_DESC NATIVE_Gambas[] =
{
  ...
  //GB_CONSTANT("Lang", "i", GB_COMP_LANG),
