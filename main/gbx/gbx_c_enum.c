...
PUBLIC CENUM *CENUM_create(void *enum_object)
{
  ...
  OBJECT_new((void **)&_object, CLASS_Enum, NULL, NULL);
  OBJECT_UNREF_KEEP((void **)&_object, "CENUM_create");
  
  THIS->enum_object = enum_object;
  GB_Ref(enum_object);

  LIST_insert((void **)&_enum_list, THIS, &THIS->list);
...
BEGIN_METHOD_VOID(CENUM_free)
  ...
  LIST_remove((void **)&_enum_list, THIS, &THIS->list);
  GB_Unref((void **)&THIS->enum_object);
