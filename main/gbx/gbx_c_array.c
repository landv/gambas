...
static long find(CARRAY *_object, int mode, void *value)
{
...
PUBLIC GB_DESC NATIVE_StringArray[] =
{
  ...
  GB_METHOD("Exist", "b", CARRAY_string_exist, "(Value)s"),
...
PUBLIC void CARRAY_split(CARRAY *_object, const char *str, long lstr, const char *sep, const char *esc, bool no_void)
{
	int i;
	char c;
	bool escape;
