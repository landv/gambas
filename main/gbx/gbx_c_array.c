...
BEGIN_METHOD(Array_SortUsing, GB_OBJECT order)
	...
	if (count > 1)
	{
		...
		_using_func = COMPARE_get_func(order->type, 0);
...
GB_DESC NATIVE_BooleanArray[] =
{
	...
	GB_METHOD("SortUsing", "Boolean[]", Array_SortUsing, "(Order)Array"),
...
GB_DESC NATIVE_ByteArray[] =
{
	...
	GB_METHOD("SortUsing", "Byte[]", Array_SortUsing, "(Order)Array"),
...
GB_DESC NATIVE_ShortArray[] =
{
	...
	GB_METHOD("SortUsing", "Short[]", Array_SortUsing, "(Order)Array"),
...
GB_DESC NATIVE_IntegerArray[] =
{
	...
	GB_METHOD("SortUsing", "Integer[]", Array_SortUsing, "(Order)Array"),
...
GB_DESC NATIVE_LongArray[] =
{
	...
	GB_METHOD("SortUsing", "Long[]", Array_SortUsing, "(Order)Array"),
...
GB_DESC NATIVE_PointerArray[] =
{
	...
	GB_METHOD("SortUsing", "Pointer[]", Array_SortUsing, "(Order)Array"),
...
GB_DESC NATIVE_StringArray[] =
{
	...
	GB_METHOD("SortUsing", "String[]", Array_SortUsing, "(Order)Array"),
...
GB_DESC NATIVE_FloatArray[] =
{
	...
	GB_METHOD("SortUsing", "Float[]", Array_SortUsing, "(Order)Array"),
...
GB_DESC NATIVE_SingleArray[] =
{
	...
	GB_METHOD("SortUsing", "Single[]", Array_SortUsing, "(Order)Array"),
...
GB_DESC NATIVE_DateArray[] =
{
	...
	GB_METHOD("SortUsing", "Date[]", Array_SortUsing, "(Order)Array"),
...
GB_DESC NATIVE_ObjectArray[] =
{
	...
	GB_METHOD("SortUsing", "Object[]", Array_SortUsing, "(Order)Array"),
...
GB_DESC NATIVE_TemplateArray[ARRAY_TEMPLATE_NDESC] =
{
	...
	GB_METHOD("SortUsing", "*[]", Array_SortUsing, "(Order)Array"),
