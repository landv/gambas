...
PUBLIC char *STRING_subst(const char *str, long len, SUBST_FUNC get_param)
{
	uint i;
	uchar c, d;
	int np;
...
PUBLIC long STRING_search(const char *ps, long ls, const char *pp, long lp, long is, bool right, bool nocase)
{
  long pos = 0, ip;
