...
PUBLIC int TABLE_compare_ignore_case_len(const char *s1, long len1, const char *s2, long len2);
...
PUBLIC bool SYMBOL_find_old(void *symbol, int n_symbol, size_t s_symbol, int flag, const char *name, int len, const char *prefix, long *result);
