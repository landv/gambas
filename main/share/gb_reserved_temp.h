...
__02:
	...
	if (tolower(word[0]) == 'i' && tolower(word[1]) == 's') return 151;
	if (tolower(word[0]) == 'm' && tolower(word[1]) == 'e') return 57;
	if (tolower(word[0]) == 'o' && tolower(word[1]) == 'f') return 26;
	if (tolower(word[0]) == 'o' && tolower(word[1]) == 'r') return 144;
...
__03:
	...
	if (word[0] == '&' && word[1] == '/' && word[2] == '=') return 163;
	if (word[0] == '.' && word[1] == '.' && word[2] == '.') return 118;
	if (tolower(word[0]) == 'a' && tolower(word[1]) == 'n' && tolower(word[2]) == 'd') return 143;
	...
	if (tolower(word[0]) == 'd' && tolower(word[1]) == 'i' && tolower(word[2]) == 'v') return 148;
	...
	if (tolower(word[0]) == 'm' && tolower(word[1]) == 'o' && tolower(word[2]) == 'd') return 150;
	if (tolower(word[0]) == 'n' && tolower(word[1]) == 'e' && tolower(word[2]) == 'w') return 28;
	if (tolower(word[0]) == 'n' && tolower(word[1]) == 'o' && tolower(word[2]) == 't') return 145;
	...
	if (tolower(word[0]) == 'x' && tolower(word[1]) == 'o' && tolower(word[2]) == 'r') return 146;
	return -1;
__04:
	...
	if (tolower(word[0]) == 'e' && tolower(word[1]) == 'n' && tolower(word[2]) == 'd' && tolower(word[3]) == 's') return 154;
	...
	if (tolower(word[0]) == 'l' && tolower(word[1]) == 'i' && tolower(word[2]) == 'k' && tolower(word[3]) == 'e') return 152;
...
__06:
	...
	if (tolower(word[0]) == 'b' && tolower(word[1]) == 'e' && tolower(word[2]) == 'g' && tolower(word[3]) == 'i' && tolower(word[4]) == 'n' && tolower(word[5]) == 's') return 153;
