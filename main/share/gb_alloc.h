...
#define ALLOC(_ptr, _size, _src)        MEMORY_alloc(_ptr, _size, _src)
#define ALLOC_ZERO(_ptr, _size, _src)   MEMORY_alloc_zero(_ptr, _size, _src)
#define REALLOC(_ptr, _size, _src)      MEMORY_realloc(_ptr, _size, _src)
#define FREE(_ptr, _src)                MEMORY_free(_ptr, _src)
...
#define ALLOC(_ptr, _size, _src)        MEMORY_alloc(_ptr, _size)
#define ALLOC_ZERO(_ptr, _size, _src)   MEMORY_alloc_zero(_ptr, _size)
#define REALLOC(_ptr, _size, _src)      MEMORY_realloc(_ptr, _size)
#define FREE(_ptr, _src)                MEMORY_free(_ptr)
