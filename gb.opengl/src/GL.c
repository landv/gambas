...
GB_DESC Cgl[] =
{
	...
	/* Feedback */
	GB_CONSTANT("2D", "i", GL_2D),
	GB_CONSTANT("3D", "i", GL_3D),
	GB_CONSTANT("3D_COLOR", "i", GL_3D_COLOR),
	GB_CONSTANT("3D_COLOR_TEXTURE", "i",  GL_3D_COLOR_TEXTURE),
	GB_CONSTANT("4D_COLOR_TEXTURE", "i",  GL_4D_COLOR_TEXTURE),
