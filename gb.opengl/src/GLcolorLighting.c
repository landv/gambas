...
BEGIN_METHOD(GLCOLOR4F, GB_FLOAT red; GB_FLOAT green; GB_FLOAT blue; GB_FLOAT alpha)

	glColor4d(VARG(red), VARG(green), VARG(blue), VARG(alpha));

END_METHOD

BEGIN_METHOD(GLCOLOR4I, GB_INTEGER red; GB_INTEGER green; GB_INTEGER blue; GB_INTEGER alpha)
