...
BEGIN_METHOD(GLVERTEX2F, GB_FLOAT x; GB_FLOAT y)
	...
	glVertex2f(VARG(x), VARG(y));

END_METHOD

BEGIN_METHOD(GLVERTEX3F, GB_FLOAT x; GB_FLOAT y; GB_FLOAT z)

	glVertex3f(VARG(x), VARG(y), VARG(z));

END_METHOD

BEGIN_METHOD(GLVERTEX4F, GB_FLOAT x; GB_FLOAT y; GB_FLOAT z; GB_FLOAT w)

	glVertex4f(VARG(x), VARG(y), VARG(z), VARG(w));
...
BEGIN_METHOD(GLVERTEX4I, GB_INTEGER x; GB_INTEGER y; GB_INTEGER z; GB_INTEGER w)
