...
[
  AM_INIT_AUTOMAKE($1, 2.99.2)
  ##AM_SILENT_RULES([yes])
  AM_CONFIG_HEADER([config.h])
  AC_DEFINE(GAMBAS_FULL_VERSION, 0x02990002, [Full Gambas version])
  AC_DEFINE(GAMBAS_PCODE_VERSION, 0x03000000, [Gambas bytecode version])
  GB_CLEAR_MESSAGES
])
