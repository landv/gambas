...
[
  AM_INIT_AUTOMAKE($1, 1.9.49)
  AM_CONFIG_HEADER(config.h)
  AC_DEFINE(GAMBAS_FULL_VERSION, 0x01090049, [Full Gambas version])
  AC_DEFINE(GAMBAS_PCODE_VERSION, 0x01090049, [Gambas bytecode version])
])
