...
[
  AM_INIT_AUTOMAKE($1, 1.9.46)
  AM_CONFIG_HEADER(config.h)
  AC_DEFINE(GAMBAS_FULL_VERSION, 0x01090046, [Full Gambas version])
  AC_DEFINE(GAMBAS_PCODE_VERSION, 0x01090046, [Gambas bytecode version])
])
