...
*  Modified in 2006 for implementing Gambas offline help
*
***************************************************************/
	...
	if(ctlImg.id != "rootFolder"){
		...
		if(childExists(tr)){
			...
			if(s.display == ""){
				...
				//fldImg.src = jst_image_folder + "/" + nodes["closed_folder.png"
			}else{
				s.display = ""
