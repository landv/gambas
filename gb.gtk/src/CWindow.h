...
#define CWINDOW_PROPERTIES CWIDGET_PROPERTIES \
  ",Text,Icon,Picture,Mask,Persistent,Border,Minimized,Maximized,FullScreen,TopOnly,SkipTaskbar,Arrangement,Spacing,Padding"
