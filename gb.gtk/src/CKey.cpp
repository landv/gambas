...
GB_DESC CKeyDesc[] =
{
  ...
  GB_CONSTANT("ShiftKey", "i", GDK_KEY_Shift_L),
  GB_CONSTANT("ControlKey", "i", GDK_KEY_Control_L),
  GB_CONSTANT("MetaKey", "i", GDK_KEY_Meta_L),
  GB_CONSTANT("AltKey", "i", GDK_KEY_Alt_L),
