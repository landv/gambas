...
{
  GB_DECLARE(".ListView.Item", 0), GB_VIRTUAL_CLASS(), 
...
{
  GB_DECLARE(".TreeView.Item", 0), GB_VIRTUAL_CLASS(), GB_HOOK_CHECK(check_valid_item),
...
{
  GB_DECLARE(".ColumnView.Item", 0), GB_VIRTUAL_CLASS(), GB_HOOK_CHECK(check_valid_item),
