...
GB_DESC CMouseDesc[] =
{
  ...
  GB_CONSTANT("SizeN", "i", GDK_SB_UP_ARROW),
  GB_CONSTANT("SizeS", "i", GDK_SB_DOWN_ARROW),
  GB_CONSTANT("SizeW", "i", GDK_SB_LEFT_ARROW),
  GB_CONSTANT("SizeE", "i", GDK_SB_RIGHT_ARROW),
