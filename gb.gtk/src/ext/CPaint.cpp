...
GB_DESC CPaintDesc[] =
{
  ...
  GB_STATIC_METHOD("Arrow",NULL,CPAINT_arrow,"(X)i(Y)i(Width)i(Height)i(Type)i[(Filled)b]"),
  GB_STATIC_METHOD("Box",NULL,CPAINT_box,"(X)i(Y)i(Width)i(Height)i"),
  GB_STATIC_METHOD("BoxGap",NULL,CPAINT_boxgap,"(X)i(Y)i(Width)i(Height)i(GapSide)i(GapX)i(GapWidth)i"),
  ...
  GB_STATIC_METHOD("Expander",NULL,CPAINT_expander,"(X)i(Y)i(Style)i"),
  GB_STATIC_METHOD("Extension",NULL,CPAINT_extension,"(X)i(Y)i(Width)i(Height)i(Position)i(Type)i"),
  ...
  GB_STATIC_METHOD("Polygon",NULL,CPAINT_polygon,"(Points)Integer[];[(Filled)b]"),
  GB_STATIC_METHOD("ResizeGrip",NULL,CPAINT_resizegrip,"(X)i(Y)i(Width)i(Height)i(Edge)i"),
  GB_STATIC_METHOD("Shadow",NULL,CPAINT_shadow,"(X)i(Y)i(Width)i(Height)i"),
  GB_STATIC_METHOD("ShadowGap",NULL,CPAINT_shadowgap,"(X)i(Y)i(Width)i(Height)i(GapSide)i(GapX)i(GapWidth)i"),
